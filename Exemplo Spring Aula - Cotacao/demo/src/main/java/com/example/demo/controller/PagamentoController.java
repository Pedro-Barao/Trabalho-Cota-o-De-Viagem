...
public class PagamentoController {
    ...
    @Operation(summary = "Atualiza o status de um pagamento (PENDENTE/PAGO)")
    @PatchMapping("/{id}/status")
    public ResponseEntity<ApiResponse<PagamentoDTO>> atualizarStatus(@PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(new ApiResponse<>(new ErrorResponse("Erro ao atualizar status", e.getMessage())));
        }
    }
