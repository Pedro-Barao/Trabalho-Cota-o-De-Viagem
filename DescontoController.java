...
public class DescontoController {
    ...
    @Operation(
        ...
        description = "Retorna todos os descontos cadastrados no desconto no sistema"
    )
    @GetMapping
    ...
    @Operation(
        summary = "Busca um desconto por ID",
        description = "Retorna os detalhes de um desconto"
    )
    @GetMapping("/{id}")
    ...
    @Operation(
        summary = "Cria um novo desconto",
        description = "Cadastra um novo desconto no sistema"
    )
    @PostMapping
    public ResponseEntity<ApiResponse<DescontoDTO>> criarDesconto(
        ...
        try {
            ...
            ApiResponse<DescontoDTO> response =
                    new ApiResponse<>(savedDesconto);
            ...
            ErrorResponse errorResponse =
                    new ErrorResponse("Argumento Inválido", e.getMessage());
    ...
    @Operation(
        ...
        description = "Remove um desconto do sistema pelo id"
    )
    @DeleteMapping("/{id}")
